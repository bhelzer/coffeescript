...
(function() {
  ...
  SWITCHES = [['-c', '--compile', 'compile to JavaScript and save as .js files'], ['-h', '--help', 'display this help message'], ['--no-header', 'suppress the "Generated by" header'], ['-m', '--map', 'generate source map and save as .js.map files'], ['-M', '--inline-map', 'generate source map and include it directly in output'], ['-o', '--output [DIR]', 'set the output directory for compiled JavaScript'], ['-w', '--watch', 'watch scripts for changes and rerun commands']];
