...
(function() {
  ...
  exports.Block = Block = (function(superClass1) {
    ...
    function Block(nodes) {
      ...
      this.es6_class_definition = false;
    }
    ...
    Block.prototype.compileWithDeclarations = function(o) {
      ...
      scope = o.scope;
      if (scope.expressions === this && !this.es6_class_definition) {
  ...
  exports.Value = Value = (function(superClass1) {
    ...
    function Value(base, props, tag) {
      ...
      this.es6_static_function = false;
      return this;
    }
    ...
    Value.prototype.compileNode = function(o) {
      ...
      if (!this.es6_static_function || o.scope.method.klass) {
      ...
      for (j = 0, len1 = props.length; j < len1; j++) {
        prop = props[j];
        prop.es6_static_function = this.es6_static_function;
  ...
  exports.ES6PrototypeVariable = ES6PrototypeVariable = (function(superClass1) {
    extend1(ES6PrototypeVariable, superClass1);

    function ES6PrototypeVariable(base, props, tag) {
      ES6PrototypeVariable.__super__.constructor.call(this, base, props, tag);
    }

    ES6PrototypeVariable.prototype.compileNode = function(o) {
      var fragments, name, ref3;
      this.base.front = this.front;
      fragments = [];
      fragments.push(this.makeCode('get '));
      ref3 = this.properties, name = ref3[ref3.length - 1];
      fragments.push.apply(fragments, name.compileToFragments(o));
      fragments.push(this.makeCode('()'));
      return fragments;
    };

    return ES6PrototypeVariable;

  })(Value);

  exports.ES6PrototypeValueReturn = ES6PrototypeValueReturn = (function(superClass1) {
    extend1(ES6PrototypeValueReturn, superClass1);

    function ES6PrototypeValueReturn(value) {
      ES6PrototypeValueReturn.__super__.constructor.call(this, value);
      this.value = value;
    }

    ES6PrototypeValueReturn.prototype.compileNode = function(o) {
      var fragments;
      fragments = [];
      fragments.push(this.makeCode("{\n" + this.tab + this.tab + "return "));
      o.indent += TAB;
      fragments.push.apply(fragments, this.value.compileToFragments(o));
      o.indent -= TAB;
      fragments.push(this.makeCode(";\n" + this.tab + "}"));
      return fragments;
    };

    return ES6PrototypeValueReturn;
  ...
  exports.ES6PrototypeCode = ES6PrototypeCode = (function(superClass1) {
    extend1(ES6PrototypeCode, superClass1);

    function ES6PrototypeCode(base, props, tag) {
      ES6PrototypeCode.__super__.constructor.call(this, base, props, tag);
    }

    ES6PrototypeCode.prototype.compileNode = function(o) {
      var fragments, name, ref3;
      this.base.front = this.front;
      fragments = [];
      ref3 = this.properties, name = ref3[ref3.length - 1];
  ...
  exports.Call = Call = (function(superClass1) {
    ...
    Call.prototype.compileNode = function(o) {
      var arg, argIndex, compiledArgs, compiledArray, es6_super_call, fragments, j, klass, len1, method, name, preface, ref3, ref4, variable;
      ...
      if (this instanceof SuperCall) {
        ...
        if (es6_super_call) {
          ...
          if (method != null ? method.klass : void 0) {
            ...
            fragments.unshift(this.makeCode("super."));
          } else {
            fragments.push(this.makeCode("super"));
          }
          fragments.push(this.makeCode("("));
        } else {
  ...
  exports.Access = Access = (function(superClass1) {
    ...
    Access.prototype.compileToFragments = function(o) {
      ...
      if (node instanceof PropertyName) {
        ...
        } else if (this.es6_static_function && !o.scope.method.klass) {
          return slice.call(name);
        } else {
  ...
  exports.Class = Class = (function(superClass1) {
          ...
          if (assign instanceof Assign) {
            ...
            if (base.value === 'constructor') {
              ...
              if (func instanceof Code) {
                assign.value = this.ctor = func;
                assign.es6_prototype_declaration = true;
                func.es6_prototype_function_declaration = true;
              ...
              if (assign.variable["this"]) {
                ...
                assign.es6_prototype_declaration = true;
                acc = base.isComplex() ? new Index(base) : new Value(base);
                if (func instanceof Code) {
                  func.es6_prototype_function_declaration = true;
    ...
    Class.prototype.compileNode = function(o) {
      var answer, args, argumentsNode, block, fragment, func, index, j, jumpNode, klass, len1, lname, name, ref3, ref4, superClass;
      ...
      block = Block.wrap([this.body]);
      block.es6_class_definition = true;
      func = new Code([], block);
      func.es6_class_definition = true;
      args = [];
      ...
      if (this.parent) {
        if (func.es6_class_definition) {
          superClass = new IdentifierLiteral(this.getFullyQualifiedSuperClassName());
        } else {
      ...
      if (func.es6_class_definition) {
        answer = [];
        answer.push(this.makeCode('class '));
        answer.push(this.makeCode(this.variable.base.value));
        if (!!this.parent) {
          answer.push(this.makeCode(' extends '));
        }
        ref4 = func.compileToFragments(o);
    ...
    Class.prototype.getFullyQualifiedSuperClassName = function() {
      var baseClassName, ref3;
      baseClassName = this.parent.base.value;
      if (((ref3 = this.parent.properties) != null ? ref3.length : void 0) > 0) {
        baseClassName = baseClassName + '.' + this.parent.properties[0].name.value;
      }
  ...
  exports.Assign = Assign = (function(superClass1) {
    ...
    function Assign(variable1, value1, context, options) {
      ...
      if (this.variable.base instanceof ThisLiteral && this.variable.properties && this.variable.properties.length === 1 && this.value instanceof Code) {
        this.variable.es6_static_function = true;
        this.value.es6_static_function = true;
      }
    }
    ...
    Assign.prototype.compileNode = function(o) {
      var answer, compiledName, isValue, j, name, properties, prototype, ref3, ref4, ref5, ref6, ref7, ref8, signToken, val, varBase;
      ...
      if (this.es6_prototype_declaration) {
        signToken = '';
      } else if (this.value.es6_static_function && !o.scope.method.klass) {
        signToken = '';
        compiledName.unshift(this.makeCode("static "));
      } else {
        signToken = '= ';
      }
      answer = compiledName.concat(this.makeCode(" " + (this.context || signToken)), val);
  ...
  exports.Code = Code = (function(superClass1) {
    ...
    function Code(params, body, tag) {
      ...
      this.es6_class_definition = false;
      this.es6_prototype_function_declaration = false;
      this.es6_static_function = false;
    }
    ...
    Code.prototype.compileNode = function(o) {
      ...
      if (this.bound && !this.context) {
         ...
         */
        this.es6_needs_fat_arrow = true;
        if (this.es6_needs_fat_arrow) {
          this.context = 'this';
        } else {
          this.context = '_this';
      ...
      for (k = 0, len2 = ref5.length; k < len2; k++) {
        ...
        for (l = 0, len3 = ref6.length; l < len3; l++) {
          ...
          if (!(p instanceof Expansion) && p.name.value) {
            o.scope.add(p.name.value, 'let', true);
          }
        }
      ...
      if (!(wasEmpty || this.noReturn || this.es6_class_definition)) {
        this.body.makeReturn();
      }
      if (this.es6_class_definition) {
        code = '';
      } else if (this.es6_prototype_function_declaration || this.es6_needs_fat_arrow || (this.es6_static_function && o.scope.method.klass)) {
        code = '';
        if (this.isGenerator) {
          code += '*';
        }
      ...
      if (this.es6_class_definition) {
        answer.push(this.makeCode(' {\n'));
      } else if (this.es6_needs_fat_arrow) {
        answer.push(this.makeCode(') => {'));
      } else {
        answer.push(this.makeCode(') {'));
      }
  ...
  UTILITIES = {
    ...
    indexOf: function() {
      return "[].indexOf || function(item) { for (let i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; }";
    },
    modulo: function() {
